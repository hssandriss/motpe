...
class torchModel(nn.Module):
    ...
    def __init__(self, config, input_shape=(1, 28, 28), num_classes=10):
        ...
        glob_avg_pool = config['global_avg_pooling'] if 'global_avg_pooling' in config else True
        ...
        self.pooling = nn.AdaptiveAvgPool2d(1) if glob_avg_pool else nn.Identity()
